...
fn create__grayscale_image_with_text(strings: &Vec<Vec<&str>>, gray_scale_color: &Vec<Vec<f64>>, filename: &str, font_size: f32) {
...
fn main() -> Result<(), Error> {
    ...
    create__grayscale_image_with_text(&ascii_image, &reduced_image, ascii_name.as_str(), 20.0);
